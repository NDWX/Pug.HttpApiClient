...
namespace Pug.HttpApiClient.Json
{
	...
	public static class IHttpApiClientJsonExtensions
	{
		...
		/// <summary>
		/// Default JsonSerializationSettings
		/// </summary>
		public static JsonSerializerSettings DefaultJsonSerializerSettings => defaultJsonSerializerSettings;

		/// <summary>
		/// Set default JsonSerializerSettings used for JSON serialization/deserialization
		/// </summary>
		...
		{
			return JsonSerializer.Create(settings ?? defaultJsonSerializerSettings);
		}
#else
